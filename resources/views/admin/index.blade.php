  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body">
          <p>You are running Pyrodactyl panel version <code>{{ config('app.version') }}</code>.</p>

          <div class="row" style="margin-top: 10px;">
            <div class="col-xs-6 col-sm-3 text-center">
              <a href="https://discord.gg/UhuYKKK2uM">
            ...
            <div class="col-xs-6 col-sm-3 text-center">
              <a href="https://github.com/jsemolik/pyrodactyl-oss">
                <button class="btn btn-primary" style="width:100%;">
