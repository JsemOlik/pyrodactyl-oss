...
const getUsageBackground = (percent: number | null) => {
    ...
    return {
        backgroundImage:
            'linear-gradient(to right, color-mix(in srgb, var(--color-brand) 35%, transparent), color-mix(in srgb, var(--color-brand) 35%, transparent)), bg-gradient-to-b from-[#ffffff08] to-[#ffffff05]',
