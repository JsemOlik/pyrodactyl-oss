        ...
        <ServerContentBlock title={'Home'}>
            <div className='w-full h-full min-h-full flex-1 flex flex-col px-2 sm:px-0'>
                ...
                >
                    <MainPageHeader
                        ...
                        titleChildren={
                            ...
                            >
                                <div className='inline-flex relative max-w-50 min-w-35 block ms:hidden md:hidden justify-left left-0 mb-4 flex gap-2'></div>
                ...
                <div className='flex flex-col gap-3 sm:gap-4'>
                    ...
                    >
                        <div className='bg-gradient-to-b from-[#ffffff08] to-[#ffffff05] border-[1px] border-[#ffffff12] rounded-xl p-3 sm:p-4 hover:border-[#ffffff20] transition-all duration-150 shadow-sm min-h-[260px]'>
                            <Console />
                        </div>
                    </div>
